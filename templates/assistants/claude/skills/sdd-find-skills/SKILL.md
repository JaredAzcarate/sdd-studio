...
- [STANDARDS.md](STANDARDS.md) — signal extraction, table format, quality bar, install rules
- [EXAMPLES.md](EXAMPLES.md) — sample flows and tables
...
3. **Verify quality** before adding to the table (see [STANDARDS.md](STANDARDS.md)):
