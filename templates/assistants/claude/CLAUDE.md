...
- Read `.workspace/brief/technical/` for engineering principles, decisions, conventions, modeling, and stack.
...
- Brief: `brief/business/` (product-principles, product-guide) + `brief/technical/` (engineering-principles, engineering-decisions, engineering-conventions, engineering-modeling, engineering-stack)
