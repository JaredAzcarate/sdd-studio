...
- .github/sdd-studio/sdd-plan/STANDARDS.md — workflow naming and IDs
- .github/sdd-studio/sdd-plan/EXAMPLES.md — reference release-001
...
4. Read .github/sdd-studio/sdd-plan/STANDARDS.md and .github/sdd-studio/sdd-plan/EXAMPLES.md.
...
Derive tasks from spec capabilities and flows. Each task in `tasks.md` with mandatory fields (see .github/sdd-studio/sdd-plan/STANDARDS.md).
