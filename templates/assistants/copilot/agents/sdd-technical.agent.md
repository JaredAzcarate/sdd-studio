...
- Which stack sections apply (see .github/sdd-studio/sdd-technical/STANDARDS.md)
...
2. Create or update `.workspace/brief/technical/engineering-stack.md` per .github/sdd-studio/sdd-technical/STANDARDS.md and .github/sdd-studio/sdd-technical/EXAMPLES.md.
