...
- .github/sdd-studio/sdd-technical/STANDARDS.md — analysis rules and output structure
...
For every layer (see .github/sdd-studio/sdd-technical/STANDARDS.md):
...
Create or update `.workspace/brief/technical/engineering-stack.md` per .github/sdd-studio/sdd-technical/STANDARDS.md and .github/sdd-studio/sdd-technical/EXAMPLES.md.
