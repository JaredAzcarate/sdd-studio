...
**`engineering-principles.md`, `engineering-decisions.md`, `engineering-conventions.md`** — created by `sdd-studio configure`. sdd-idea does not write these files.

**`engineering-stack.md`** — created by **sdd-technical**. sdd-idea does not write this file.
...
Belongs in `engineering-stack.md` (generated by **sdd-technical**).
...
**Incorrect — product journey in engineering-modeling.md:**
...
**Incorrect — writing engineering input files:**
...
Monorepo with feature-first layout
```

Belongs in `engineering-decisions.md` via `sdd-studio configure`, not sdd-idea.

**Incorrect — writing stack in engineering-modeling.md:**

```markdown
## Modeling Principles

We use PostgreSQL and Next.js Server Actions.
```

Technology choices belong in `engineering-stack.md` via **sdd-technical**.
