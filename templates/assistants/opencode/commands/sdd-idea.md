...
- @.opencode/sdd-studio/sdd-idea/STANDARDS.md — structure and rules for all three files
...
Write files in this order, following @.opencode/sdd-studio/sdd-idea/STANDARDS.md exactly:
...
Review manually against @.opencode/sdd-studio/sdd-idea/STANDARDS.md:
