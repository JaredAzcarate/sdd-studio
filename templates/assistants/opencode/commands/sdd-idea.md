...
- @.opencode/sdd-studio/sdd-idea/STANDARDS.md — structure and rules for both files
...
Write both files following @.opencode/sdd-studio/sdd-idea/STANDARDS.md exactly.
