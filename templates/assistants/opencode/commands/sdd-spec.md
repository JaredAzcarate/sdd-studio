...
- @.opencode/sdd-studio/sdd-spec/STANDARDS.md — naming, folders, and templates
- @.opencode/sdd-studio/sdd-spec/EXAMPLES.md — complete reference `task` domain
...
6. Read @.opencode/sdd-studio/sdd-spec/STANDARDS.md and @.opencode/sdd-studio/sdd-spec/EXAMPLES.md.
...
Use the exact templates from @.opencode/sdd-studio/sdd-spec/STANDARDS.md. See @.opencode/sdd-studio/sdd-spec/EXAMPLES.md for the `task` domain.
