...
- @.opencode/sdd-studio/sdd-technical/STANDARDS.md — analysis rules and output structure
...
For every layer (see @.opencode/sdd-studio/sdd-technical/STANDARDS.md):
...
Create or update `.workspace/brief/technical/engineering-stack.md` per @.opencode/sdd-studio/sdd-technical/STANDARDS.md and @.opencode/sdd-studio/sdd-technical/EXAMPLES.md.
