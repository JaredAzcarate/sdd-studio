...
From the Engineering Brief, determine which stack sections apply (see @.opencode/sdd-studio/sdd-technical/STANDARDS.md — types A/B/C/D).
...
2. Write `.workspace/brief/technical/engineering-stack.md` per @.opencode/sdd-studio/sdd-technical/STANDARDS.md and @.opencode/sdd-studio/sdd-technical/EXAMPLES.md.
