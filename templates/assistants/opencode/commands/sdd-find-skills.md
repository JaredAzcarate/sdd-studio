...
- @.opencode/sdd-studio/sdd-find-skills/STANDARDS.md — signal extraction, table format, quality bar, install rules
- @.opencode/sdd-studio/sdd-find-skills/EXAMPLES.md — sample flows and tables
...
3. Read @.opencode/sdd-studio/sdd-find-skills/STANDARDS.md and @.opencode/sdd-studio/sdd-find-skills/EXAMPLES.md.
...
3. **Verify quality** before adding to the table (see @.opencode/sdd-studio/sdd-find-skills/STANDARDS.md):
